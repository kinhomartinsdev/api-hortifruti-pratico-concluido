...
export default class PedidosController {
  public async store({ auth, response, request }: HttpContextContract) {
    ...
    try {
      ...
      const estabCidade = CidadesEstabelecimento.query()
      ...
      valorTotal = estabCidade ? valorTotal + (await estabCidade).custo_entrega
      : valorTotal;
